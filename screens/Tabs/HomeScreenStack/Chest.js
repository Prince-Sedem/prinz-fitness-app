  ...
  return (
    <View>
       <View className="flex-row justify-around"> 
                ...
                <TouchableOpacity onPress={() => navigation.navigate("ChestEx2")}>
        ...
        <ScrollView className="mt-2 mb-2 h-[630px] ">
          <TouchableOpacity onPress={() => navigation.navigate("BenchPress")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("InclinePress")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("DeclinePress")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("CloseGripBenchPress")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("DumbbellPress")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("DumbbellInclinePress")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("DumbbellDeclinePress")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("DumbbellFly")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("CableStandingChestPress")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("CableMiddleFly")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("CableLowFly")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("CableCrossoverFly")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("LeverPecDeckFly")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("PushupsGym")}>
            <View>
