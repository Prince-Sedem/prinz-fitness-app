    ...
    <View>
       <View className="flex-row justify-around"> 
        ...
        <ScrollView className="mt-2 mb-2 h-[630px] ">
          <TouchableOpacity onPress={() => navigation.navigate("CrunchesHome")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("PelvicTiltHome")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("SitUpsHome")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("TwistCrunchHome")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("NormalPlanksHome")}>
            <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("SidePlanksHome")}>
            <View>
